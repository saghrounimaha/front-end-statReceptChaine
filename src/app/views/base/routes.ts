...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      {
        path: 'Quantite-par-famille',
        loadComponent: () => import('./performanceParFamille/performanceParFamille.component').then(m => m.PerformanceParFamilleComponent),
        data: {
          title: 'Quantite par famille'
        }
      },
      {
        path: 'Rendement-par-chaine',
        loadComponent: () => import('./breadcrumbs/breadcrumbs.component').then(m => m.BreadcrumbsComponent),
        data: {
          title: 'Rendement par chaine'
        }
      },
      {
        path: 'cards',
