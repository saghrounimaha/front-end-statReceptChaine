...
@Component({
    selector: 'app-performanceParFamille',
    templateUrl: './performanceParFamille.component.html',
    styleUrls: ['./performanceParFamille.component.scss'],
    standalone: true,
...
export class PerformanceParFamilleComponent implements OnInit {
  chartData:any
  items = [1, 2, 3, 4];
  basicOptions: any;
